  ...
  return (
    <div className="app-container">
      ...
      <div className="overlay-ui">
        ...
        {/* Permanent Aviation Disclaimer */}
        {disclaimerVisible && (
          <div className="disclaimer-banner glass-panel ui-element" style={{ position: 'absolute', bottom: '20px', left: '50%', transform: 'translateX(-50%)', width: '90%', maxWidth: '900px', padding: '16px 24px', zIndex: 2000, display: 'flex', flexDirection: 'column', gap: '10px', borderTop: '4px solid #ef4444', background: theme === 'dark' ? 'rgba(15, 23, 42, 0.95)' : 'rgba(255, 255, 255, 0.98)', boxShadow: '0 20px 50px rgba(0,0,0,0.5)' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', color: '#ef4444' }}>
              <AlertTriangle size={20} />
              <span className="font-bold text-sm" style={{ letterSpacing: '0.5px' }}>CRITICAL AVIATION DISCLAIMER — EXPERIMENTAL AI SYSTEM</span>
              <button 
                onClick={() => setDisclaimerVisible(false)} 
                className="glass-pill hover-scale" 
                style={{ marginLeft: 'auto', padding: '6px 16px', fontSize: '0.75rem', fontWeight: 'bold', border: '1px solid #ef4444', color: '#ef4444', background: 'transparent', cursor: 'pointer' }}
              >
                I ACCEPT & AGREE
              </button>
            </div>
